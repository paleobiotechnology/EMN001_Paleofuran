...
- `FigureS_PHYL13.pdf`: Supplemntary figure illustrating the gene topology of the porphyrin orthologous
  genes as characterised by KEGG on the contig containing the *afsa* gene
- `FigureS_FUNC001.pdf`: Supplementary figure illustrating the number of KEGG orthologs grouped by
  KEGG BRITE hierarchies that were specific for either *C. limicola* or the ancient Chlorobium MAGs
